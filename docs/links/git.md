...
## Online resources
- [How Git Version Control Works?](https://www.geeksforgeeks.org/how-git-version-control-works/)
...
#### Some other tutorial and videos
- **lazygit**
  - [LazyGit makes you 10x faster while using Git.](https://www.youtube.com/watch?v=tDOxm4P3udo)
  - [I'm never using Git the same way again](https://www.youtube.com/watch?v=TLNdwvIFoCg)
...
#### Udemy 
- [Master Git and GitHub in 5 Days: Go from Zero to Hero](https://thoughtworks.udemy.com/course/master-git-and-github-in-5-days-go-from-zero-to-hero/)
- [The Git & Github Bootcamp](https://thoughtworks.udemy.com/course/git-and-github-bootcamp/)
